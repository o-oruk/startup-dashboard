        ...
        {upcoming.map((event) => {
          ...
          return (
            <button
              ...
              className="flex min-w-[160px] shrink-0 flex-col gap-1 rounded-lg border border-accent/20 bg-white px-3 py-2.5 text-left shadow-sm transition-transform hover:-translate-y-0.5 hover:shadow-md"
